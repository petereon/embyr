...
func (x *StructuredAggregationQuery) GetQueryType() isStructuredAggregationQuery_QueryType {
	if x != nil {
		return x.QueryType
	}
	return nil
...
func (x *StructuredAggregationQuery) GetStructuredQuery() *StructuredQuery {
	if x != nil {
		if x, ok := x.QueryType.(*StructuredAggregationQuery_StructuredQuery); ok {
...
func (x *StructuredAggregationQuery_Aggregation) GetOperator() isStructuredAggregationQuery_Aggregation_Operator {
	if x != nil {
		return x.Operator
	}
	return nil
...
func (x *StructuredAggregationQuery_Aggregation) GetCount() *StructuredAggregationQuery_Aggregation_Count {
	if x != nil {
		if x, ok := x.Operator.(*StructuredAggregationQuery_Aggregation_Count_); ok {
			return x.Count
		}
	}
	return nil
...
func (x *StructuredAggregationQuery_Aggregation) GetSum() *StructuredAggregationQuery_Aggregation_Sum {
	if x != nil {
		if x, ok := x.Operator.(*StructuredAggregationQuery_Aggregation_Sum_); ok {
			return x.Sum
		}
	}
	return nil
...
func (x *StructuredAggregationQuery_Aggregation) GetAvg() *StructuredAggregationQuery_Aggregation_Avg {
	if x != nil {
		if x, ok := x.Operator.(*StructuredAggregationQuery_Aggregation_Avg_); ok {
			return x.Avg
		}
	}
	return nil
...
const file_google_firestore_v1_query_proto_rawDesc = "" +
	"\n" +
	"\x1fgoogle/firestore/v1/query.proto\x12\x13google.firestore.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\"google/firestore/v1/document.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\xb4\x16\n" +
	"\x0fStructuredQuery\x12G\n" +
	"\x06select\x18\x01 \x01(\v2/.google.firestore.v1.StructuredQuery.ProjectionR\x06select\x12K\n" +
	"\x04from\x18\x02 \x03(\v27.google.firestore.v1.StructuredQuery.CollectionSelectorR\x04from\x12A\n" +
	"\x05where\x18\x03 \x01(\v2+.google.firestore.v1.StructuredQuery.FilterR\x05where\x12E\n" +
	"\border_by\x18\x04 \x03(\v2*.google.firestore.v1.StructuredQuery.OrderR\aorderBy\x126\n" +
	"\bstart_at\x18\a \x01(\v2\x1b.google.firestore.v1.CursorR\astartAt\x122\n" +
	"\x06end_at\x18\b \x01(\v2\x1b.google.firestore.v1.CursorR\x05endAt\x12\x16\n" +
	"\x06offset\x18\x06 \x01(\x05R\x06offset\x121\n" +
	"\x05limit\x18\x05 \x01(\v2\x1b.google.protobuf.Int32ValueR\x05limit\x12X\n" +
	"\ffind_nearest\x18\t \x01(\v20.google.firestore.v1.StructuredQuery.FindNearestB\x03\xe0A\x01R\vfindNearest\x1ab\n" +
	"\x12CollectionSelector\x12#\n" +
	"\rcollection_id\x18\x02 \x01(\tR\fcollectionId\x12'\n" +
	"\x0fall_descendants\x18\x03 \x01(\bR\x0eallDescendants\x1a\xa8\x02\n" +
	"\x06Filter\x12a\n" +
	"\x10composite_filter\x18\x01 \x01(\v24.google.firestore.v1.StructuredQuery.CompositeFilterH\x00R\x0fcompositeFilter\x12U\n" +
	"\ffield_filter\x18\x02 \x01(\v20.google.firestore.v1.StructuredQuery.FieldFilterH\x00R\vfieldFilter\x12U\n" +
	"\funary_filter\x18\x03 \x01(\v20.google.firestore.v1.StructuredQuery.UnaryFilterH\x00R\vunaryFilterB\r\n" +
	"\vfilter_type\x1a\xde\x01\n" +
	"\x0fCompositeFilter\x12M\n" +
	"\x02op\x18\x01 \x01(\x0e2=.google.firestore.v1.StructuredQuery.CompositeFilter.OperatorR\x02op\x12E\n" +
	"\afilters\x18\x02 \x03(\v2+.google.firestore.v1.StructuredQuery.FilterR\afilters\"5\n" +
	"\bOperator\x12\x18\n" +
	"\x14OPERATOR_UNSPECIFIED\x10\x00\x12\a\n" +
	"\x03AND\x10\x01\x12\x06\n" +
	"\x02OR\x10\x02\x1a\xaa\x03\n" +
	"\vFieldFilter\x12I\n" +
	"\x05field\x18\x01 \x01(\v23.google.firestore.v1.StructuredQuery.FieldReferenceR\x05field\x12I\n" +
	"\x02op\x18\x02 \x01(\x0e29.google.firestore.v1.StructuredQuery.FieldFilter.OperatorR\x02op\x120\n" +
	"\x05value\x18\x03 \x01(\v2\x1a.google.firestore.v1.ValueR\x05value\"\xd2\x01\n" +
	"\bOperator\x12\x18\n" +
	...
	"\x1a\x95\x02\n" +
	"\vUnaryFilter\x12I\n" +
	"\x02op\x18\x01 \x01(\x0e29.google.firestore.v1.StructuredQuery.UnaryFilter.OperatorR\x02op\x12K\n" +
	"\x05field\x18\x02 \x01(\v23.google.firestore.v1.StructuredQuery.FieldReferenceH\x00R\x05field\"^\n" +
	"\bOperator\x12\x18\n" +
	"\x14OPERATOR_UNSPECIFIED\x10\x00\x12\n" +
	"\n" +
	"\x06IS_NAN\x10\x02\x12\v\n" +
	"\aIS_NULL\x10\x03\x12\x0e\n" +
	"\n" +
	"IS_NOT_NAN\x10\x04\x12\x0f\n" +
	"\vIS_NOT_NULL\x10\x05B\x0e\n" +
	"\foperand_type\x1a\xa0\x01\n" +
	"\x05Order\x12I\n" +
	"\x05field\x18\x01 \x01(\v23.google.firestore.v1.StructuredQuery.FieldReferenceR\x05field\x12L\n" +
	"\tdirection\x18\x02 \x01(\x0e2..google.firestore.v1.StructuredQuery.DirectionR\tdirection\x1a/\n" +
	"\x0eFieldReference\x12\x1d\n" +
	"\n" +
	"field_path\x18\x02 \x01(\tR\tfieldPath\x1aY\n" +
	"\n" +
	"Projection\x12K\n" +
	"\x06fields\x18\x02 \x03(\v23.google.firestore.v1.StructuredQuery.FieldReferenceR\x06fields\x1a\xc4\x04\n" +
	"\vFindNearest\x12[\n" +
	"\fvector_field\x18\x01 \x01(\v23.google.firestore.v1.StructuredQuery.FieldReferenceB\x03\xe0A\x02R\vvectorField\x12B\n" +
	"\fquery_vector\x18\x02 \x01(\v2\x1a.google.firestore.v1.ValueB\x03\xe0A\x02R\vqueryVector\x12p\n" +
	"\x10distance_measure\x18\x03 \x01(\x0e2@.google.firestore.v1.StructuredQuery.FindNearest.DistanceMeasureB\x03\xe0A\x02R\x0fdistanceMeasure\x126\n" +
	"\x05limit\x18\x04 \x01(\v2\x1b.google.protobuf.Int32ValueB\x03\xe0A\x02R\x05limit\x127\n" +
	"\x15distance_result_field\x18\x05 \x01(\tB\x03\xe0A\x01R\x13distanceResultField\x12P\n" +
	"\x12distance_threshold\x18\x06 \x01(\v2\x1c.google.protobuf.DoubleValueB\x03\xe0A\x01R\x11distanceThreshold\"_\n" +
	"\x0fDistanceMeasure\x12 \n" +
	"\x1cDISTANCE_MEASURE_UNSPECIFIED\x10\x00\x12\r\n" +
	"\tEUCLIDEAN\x10\x01\x12\n" +
	"\n" +
	"\x06COSINE\x10\x02\x12\x0f\n" +
	"\vDOT_PRODUCT\x10\x03\"E\n" +
	"\tDirection\x12\x19\n" +
	"\x15DIRECTION_UNSPECIFIED\x10\x00\x12\r\n" +
	"\tASCENDING\x10\x01\x12\x0e\n" +
	"\n" +
	"DESCENDING\x10\x02\"\x83\x06\n" +
	"\x1aStructuredAggregationQuery\x12Q\n" +
	"\x10structured_query\x18\x01 \x01(\v2$.google.firestore.v1.StructuredQueryH\x00R\x0fstructuredQuery\x12d\n" +
	"\faggregations\x18\x03 \x03(\v2;.google.firestore.v1.StructuredAggregationQuery.AggregationB\x03\xe0A\x01R\faggregations\x1a\x9d\x04\n" +
	"\vAggregation\x12Y\n" +
	"\x05count\x18\x01 \x01(\v2A.google.firestore.v1.StructuredAggregationQuery.Aggregation.CountH\x00R\x05count\x12S\n" +
	"\x03sum\x18\x02 \x01(\v2?.google.firestore.v1.StructuredAggregationQuery.Aggregation.SumH\x00R\x03sum\x12S\n" +
	"\x03avg\x18\x03 \x01(\v2?.google.firestore.v1.StructuredAggregationQuery.Aggregation.AvgH\x00R\x03avg\x12\x19\n" +
	"\x05alias\x18\a \x01(\tB\x03\xe0A\x01R\x05alias\x1a>\n" +
	"\x05Count\x125\n" +
	"\x05up_to\x18\x01 \x01(\v2\x1b.google.protobuf.Int64ValueB\x03\xe0A\x01R\x04upTo\x1aP\n" +
	"\x03Sum\x12I\n" +
	"\x05field\x18\x01 \x01(\v23.google.firestore.v1.StructuredQuery.FieldReferenceR\x05field\x1aP\n" +
	"\x03Avg\x12I\n" +
	"\x05field\x18\x01 \x01(\v23.google.firestore.v1.StructuredQuery.FieldReferenceR\x05fieldB\n" +
	"\n" +
	"\boperatorB\f\n" +
	"\n" +
	"query_type\"T\n" +
	"\x06Cursor\x122\n" +
	"\x06values\x18\x01 \x03(\v2\x1a.google.firestore.v1.ValueR\x06values\x12\x16\n" +
	"\x06before\x18\x02 \x01(\bR\x06beforeB\xc2\x01\n" +
...
var (
	...
	file_google_firestore_v1_query_proto_rawDescData []byte
)

func file_google_firestore_v1_query_proto_rawDescGZIP() []byte {
	file_google_firestore_v1_query_proto_rawDescOnce.Do(func() {
		file_google_firestore_v1_query_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_firestore_v1_query_proto_rawDesc), len(file_google_firestore_v1_query_proto_rawDesc)))
	})
...
func file_google_firestore_v1_query_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_firestore_v1_query_proto_rawDesc), len(file_google_firestore_v1_query_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   16,
			NumExtensions: 0,
			NumServices:   0,
